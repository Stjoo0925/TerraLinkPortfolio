        ...
        <>
            <div className="flex justify-center mb-10">
                <div className="relative p-6 px-12 rounded-3xl bg-black/10 backdrop-blur-md border border-white/10 shadow-xl text-center">
                    <span className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-slate-100 text-rose-600 font-bold tracking-wider text-sm mb-6 shadow-[0_0_15px_rgba(255,255,255,0.15)] border border-white/20">
